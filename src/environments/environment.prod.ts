export const environment = {
  production: true,
  //APIEndpoint: 'https://uat.skense.ai/api/api',
  ...
  localAPIEndpoint: 'http://localhost:3000/api',
  firebase: {
...
//export const REDIRECT_URI = 'https://uat.skense.ai';
export const REDIRECT_URI = 'https://nxtgen.skense.ai';
export const POST_LOGOUT_REDIRECT_URI = 'https://nxtgen.skense.ai';
//export const POST_LOGOUT_REDIRECT_URI = 'https://uat.skense.ai';
